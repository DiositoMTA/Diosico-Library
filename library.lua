...
["TotoMode"] = {
    Topbar = Color3.fromRGB(255, 0, 120),
    TabContainer = Color3.fromRGB(0, 162, 255),
    Lines = Color3.fromRGB(255, 121, 0),
    HoverTabFrame = Color3.fromRGB(41, 49, 65),
    ItemUIStroke = Color3.fromRGB(255, 215, 0),
    TabFrame = Color3.fromRGB(255, 0, 0),
    SectionFrame = Color3.fromRGB(0, 255, 127),
    TabText = Color3.fromRGB(237, 237, 237),
    ItemText = Color3.fromRGB(237, 237, 237),
    SectionText = Color3.fromRGB(237, 237, 237),
    ItemUIStrokeSelected = Color3.fromRGB(255, 255, 255),
    SelectedTabFrame = Color3.fromRGB(0, 128, 255),
    ItemFrame = Color3.fromRGB(255, 255, 0),
    HoverItemFrame = Color3.fromRGB(0, 255, 255),
    DropdownIcon = Color3.fromRGB(175, 175, 175),
    SectionUIStroke = Color3.fromRGB(255, 0, 255),
    MainUIStroke = Color3.fromRGB(255, 0, 127),
    ...
    SliderInner = Color3.fromRGB(255, 0, 120),
    TabUIStroke = Color3.fromRGB(255, 162, 255),
    ToggleOuter = Color3.fromRGB(48, 56, 75),
    ToggleOuterEnabled = Color3.fromRGB(58, 68, 91),
    ToggleOuterUIStroke = Color3.fromRGB(255, 0, 120),
    ToggleOuterUIStrokeEnabled = Color3.fromRGB(255, 211, 105),
    ToggleInner = Color3.fromRGB(0, 255, 127),
