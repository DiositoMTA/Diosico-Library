...
["TotoMode"] = {
    ...
    TabContainer = Color3.fromRGB(255, 127, 0), 
    Lines = Color3.fromRGB(255, 255, 0),       
    HoverTabFrame = Color3.fromRGB(0, 255, 0), 
    ItemUIStroke = Color3.fromRGB(0, 0, 255), 
    TabFrame = Color3.fromRGB(139, 0, 255),   
    SectionFrame = Color3.fromRGB(255, 0, 0), 
    TabText = Color3.fromRGB(255, 255, 255),  
    ItemText = Color3.fromRGB(255, 255, 255),
    SectionText = Color3.fromRGB(255, 255, 255),
    ItemUIStrokeSelected = Color3.fromRGB(255, 127, 0),
    SelectedTabFrame = Color3.fromRGB(0, 255, 0),
    ItemFrame = Color3.fromRGB(255, 255, 0),
    HoverItemFrame = Color3.fromRGB(0, 0, 255),
    DropdownIcon = Color3.fromRGB(175, 175, 175),
    SectionUIStroke = Color3.fromRGB(139, 0, 255),
    MainUIStroke = Color3.fromRGB(255, 0, 0),
    Main = Color3.fromRGB(0, 255, 0),
    InputPlaceHolder = Color3.fromRGB(255, 255, 0),
    Shadow = Color3.fromRGB(19, 22, 29),
    SliderOuter = Color3.fromRGB(0, 0, 255),
    SliderInner = Color3.fromRGB(255, 127, 0),
    TabUIStroke = Color3.fromRGB(139, 0, 255),
    ToggleOuter = Color3.fromRGB(255, 0, 0),
    ToggleOuterEnabled = Color3.fromRGB(0, 255, 0),
    ToggleOuterUIStroke = Color3.fromRGB(255, 127, 0),
    ToggleOuterUIStrokeEnabled = Color3.fromRGB(0, 0, 255),
    ToggleInner = Color3.fromRGB(0, 255, 0),
    ToggleInnerEnabled = Color3.fromRGB(255, 255, 0),
    ContainerHolder = Color3.fromRGB(255, 0, 0),
    HighlightUIStroke = Color3.fromRGB(0, 0, 255),
    Highlight = Color3.fromRGB(139, 0, 255)
}
